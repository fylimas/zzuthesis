...
% \documentclass[bachelor|master|doctor, openany|openright]{zzuthesis}
% bachelor本科，master硕士，doctor博士
% 自定义宏包
\usepackage{docutils}
...
\bibliographystyle{zzubib.bst}%学校规范中示例的格式
\bibliography{ref/test}%参考文献的bib文件
